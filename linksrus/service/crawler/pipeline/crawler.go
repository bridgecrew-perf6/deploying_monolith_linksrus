...
//go:generate mockgen -package mocks -destination mocks/mocks.go deploying_monolith_linksrus/linksrus/service/crawler/pipeline URLGetter,PrivateNetworkDetector,Graph,Indexer
